...
/**
 * Helper class to search for kotlinx coroutines library in the transitive dependencies of the
 * target to debug.
 */
public final class KotlinxCoroutinesLibFinderHelper {

  private KotlinxCoroutinesLibFinderHelper() {}
   ...
   */
  public static Optional<ArtifactLocation> findKotlinxCoroutinesLib(
